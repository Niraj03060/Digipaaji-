...
const countries1 = [
    ...
    select_box1 = document.querySelector('.options1'),
    search_box1 = document.querySelector('.search-box1'),
    input_box1 = document.querySelector('#selectbox-1 input[type="tel"]'),
    selected_option1 = document.querySelector('.selected-option1 div');
...
function selectOption1() {
    ...
    selected_option1.append(icon, phone_code);

    input_box1.value = phone_code.innerText;
